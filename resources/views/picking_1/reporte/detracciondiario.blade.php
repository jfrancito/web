          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Detracción Diaria
                  <div class="tools tooltiptop">


                    <a href="{{url('/reporte-detraccion-diario-pdf')}}" 
                        target="_blank"
                        class='tooltipcss'
                        id="descargardetracciondiariopdf" 
                        data-href="{{url('reporte-detraccion-diario-pdf')}}"
                        title="Descargar pdf">
                        <span class="tooltiptext">Descargar pdf </span>
                        <span class="icon mdi mdi-collection-pdf"></span>
                    </a>

                    <a href="#" class="tooltipcss" id='buscardetracciondiaria' >
                ...
                <div class="panel-body selectfiltro">
                  ...
                  <div class="col-xs-12">
                    <div class='listapickingdetraccion listajax reporteajax'>
                        <div class='ajaxvacio'>
                          Seleccione un día ...
