          ...
          <div class="row">
            <div class="col-sm-12 col-mobil">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Solicitud de Transferencia - {{$opcion->parametros}}
                  <div class="tools tooltiptop">
                    
                    <!--input type="hidden" name="id_opcion" id="id_opcion" value="{{$idopcion}}"-->
                    <a href="#" class="tooltipcss opciones" id='buscarpedido' id_opcion='{{$idopcion}}'>
                      <span class="tooltiptext">Buscar Transferencia</span>
                      <span class="icon mdi mdi-search"></span>
                    </a>
                    
                     @if($opcion->parametros=='Cerrar')
                       <a href="{{ url('/agregar-transferencia/'.$idopcion.'/x') }}" class="tooltipcss opciones">
                        <span class="tooltiptext">Crear Transferencia</span>
                ...
                <div class="panel-body">
                  ...
                  <div class='listatablapedido listajax'>
                    ...
                    @include('transferencia.ajax.listatransferencia')
