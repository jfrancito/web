              ...
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Reglas de promoción y descuento
                  ...
                  <div class="tools tooltiptop">
                    ...
                    <a href="#" class="tooltipcss opciones" id='buscarreglas'>
                      <span class="tooltiptext">Buscar Reglas</span>
                      <span class="icon mdi mdi-search"></span>
                    </a>


                    <a href="{{ url('/agregar-regla-precio/'.$idopcion) }}" class="tooltipcss opciones">
                      <span class="tooltiptext">Crear Descuento del producto</span>
                      <span class="icon mdi mdi-plus-circle-o"></span>
                    </a>
                  </div>
                  <span class="panel-subtitle">Se hace un descuento al precio de producto ya sea una promocion,contrato,etc. </span>
                </div>
                <div class="panel-body">
                  ...
                  <div class='listatablareglas listajax'>
                    ...
                    @include('regla.ajax.listareglasdescuento')
