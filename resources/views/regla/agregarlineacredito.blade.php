    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-border-color panel-border-color-default">
          <div class="panel-heading panel-heading-divider" >Linea de Credito<span class="panel-subtitle">Crear regla de linea de credito</span></div>
          <div class="panel-body">

                <form method="POST"  action="{{ url('/agregar-regla-linea-credito/'.$idopcion) }}" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                    {{ csrf_field() }}

                    @include('regla.form.lineacredito')
