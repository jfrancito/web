            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Reglas x Cliente
                  <div class="tools tooltiptop">
                    ...
                    <a href="{{url('/reglas-cliente-pdf')}}" 
                        target="_blank"
                        class='tooltipcss'
                        id="descargarreglasclientepdf" 
                        data-href="{{url('/reglas-cliente-pdf')}}"
                    ...
                    <a href="{{url('/reglas-cliente-excel')}}" 
                       class='tooltipcss'
                       target="_blank"
                       id="descargarreglasclienteexcel" 
                       data-href="{{url('/reglas-cliente-excel')}}"
                       title="Descargar reglas x cliente">
                       <span class="tooltiptext">Descargar reglas x cliente </span>
                       <i class="fa fa-file-excel-o"></i>
                    </a>

                    <a href="#" class="tooltipcss" id='buscarreportereglacliente' >
                ...
                <div class="panel-body selectfiltro">
                  ...
                  <div class="col-xs-12">
                    <div class='listareglascliente listajax reporteajax'>
                        <div class='ajaxvacio'>
