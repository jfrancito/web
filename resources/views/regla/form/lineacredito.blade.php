			...
			<div class="form-group">
				<label  class="col-sm-4 control-label" >
					<div class="tooltipfr">Nombre <span class='requerido'>*</span>
					  <span class="tooltiptext">Nombre de la regla de la linea de credito</span>
					</div>
				</label>
				<div class="col-sm-8">
  ...
  <div class="panel panel-border-color panel-border-color-danger">
    ...
    <div class="panel-body">
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
			  <label class="col-sm-4 control-label">
			  		<div class="tooltipfr">Ampliacion de linea de credito <span class='requerido'>*</span>
					  <span class="tooltiptext">Ampliar la linea de credito.</span>
					</div>
			  </label>
			  <div class="col-sm-8 abajocaja">
				
                <div class="input-group xs-mb-15">
					<span class="input-group-addon">LC</span>
				    <input  type="text"
				            id="descuento" name='descuento' 
				            value="@if(isset($regla)){{old('descuento' ,$regla->descuento)}}@else{{old('descuento')}}@endif" 
				            placeholder="Ampliacion de linea de credito"
				            required = "" 
