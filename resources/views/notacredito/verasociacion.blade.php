          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Asociacon de las nota de credito <b>({{$documentonotacredito->codigo}})</b>
                ...
                <div class="panel-body selectfiltro">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="main-content container-fluid" style="padding-bottom: 0px;">
                      ...
                      <table id="tablenotacreditover" class="table table-striped table-hover table-fw-widget listatabla">
                        <thead>
                          <tr> 
