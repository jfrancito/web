<div class="main-content container-fluid" style="padding-bottom: 0px;">
  ...
  <div class="row">
    ...
    <form method="POST" action="{{ url('/agregar-orden-cen/'.$idopcion.'/'.$documentonotacredito->id) }}" style="border-radius: 0px;" class="group-border-dashed">
          {{ csrf_field() }}

      <div class="col-sm-12">
          <h2 style="font-size: 14px;text-align: center;"><b>AGREGAR ORDEN CEN ({{$documentonotacredito->codigo}})</b></h2>
          <br>
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          <div class="panel-body">
              ...
              <input type="hidden" id='totalfacturas' name='totalfacturas' value='{{$documentonotacredito->total_factura}}'>
              <input type="hidden" id='totalreglas' name='totalreglas' value='{{$documentonotacredito->total_reglas}}'>
      ...
      <div class="col-sm-4">
        <div class="panel panel-default">
          <div class="panel-body">
              <div class="from-texto form-group">
                <b>Total factura  : </b>
                <label class='totales totalfactura'>{{$documentonotacredito->total_factura}}</label>
              </div>

              <div class="from-texto form-group">
                <b>Total nota de credito  : </b>
                <label class='totales totalnotacredito'>{{$documentonotacredito->total_reglas}}</label>
              </div>
          </div>
        </div>
      </div>
