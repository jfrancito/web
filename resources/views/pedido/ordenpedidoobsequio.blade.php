        ...
        <div class="panel panel-default">
          ...
          <div class="tab-container">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#productotp" data-toggle="tab">PRODUCTOS</a></li>
              <li><a href="#pedidotp" data-toggle="tab">PEDIDO</a></li>
            </ul>
            <div class="tab-content">

              <div id="productotp" class="tab-pane active cont">
                @include('pedido.orden.productoobsequio')
              </div>

              <div id="pedidotp" class="tab-pane">
                @include('pedido.orden.pedidoobsequio')
              </div>
