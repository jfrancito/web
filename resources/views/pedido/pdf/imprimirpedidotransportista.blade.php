...
<body>
    <header>
	<div class="menu">
		<p><b>Observacion : </b> {{$pedido->glosa}}</p>
    ...
    <section>
        <article>
			...
			<div class="top">
			    ...
			    <div class="det1">
	   				<p>
	   					<strong>Autorizado :</strong> {{$funcion->funciones->data_usuario($pedido->usuario_autorizacion)->nombre}}
	   				</p>
	   				<p >
	   					<strong>Solicitud  :</strong> {{$funcion->funciones->data_usuario($pedido->usuario_crea)->nombre}}
	   				</p>

	   				<p>
	   					<strong>CLiente :</strong> {{$funcion->funciones->data_cliente($pedido->cuenta_id)->NOM_EMPR}}
	   				</p>
	   				<p >
	   					<strong>Condicción :</strong> {{$funcion->funciones->data_categoria($pedido->tipopago_id)->NOM_CATEGORIA}}
	   				</p>
	   				<p>
	   					<strong>Fecha de Entrega :</strong> {{date_format(date_create($pedido->fecha_despacho), 'd/m/Y')}}
	   				</p>  
	   				<p>
	   					<strong>Dirección de Entrega:</strong> {{$funcion->funciones->data_direccion($pedido->direccion_entrega_id)->NOM_DIRECCION}}
	   				</p>
