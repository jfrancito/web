              ...
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Lista toma de pedidos (DESPACHO)
                  <div class="tools tooltiptop">
                    ...
                    <form method="POST" id='formpedido' class='opciones' action="{{ url('/enviar-a-osiris/'.$idopcion) }}" 
                    style="display: none;" >
                      {{ csrf_field() }}
                    ...
                    <form method="POST" id='formpedidorechazar' class='opciones' action="{{ url('/enviar-a-osiris-rechazar/'.$idopcion) }}" style="display: none;" 
                    data-toggle="tooltip">
                      {{ csrf_field() }}
