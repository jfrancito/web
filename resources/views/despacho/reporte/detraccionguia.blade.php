          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-heading">Pago detracciones
                  <div class="tools tooltiptop">

                    <a href="#" class="tooltipcss" id='buscarreporteguiadetraccion' >
...
@section('script')
  ...
  <script src="{{ asset('public/lib/parsley/parsley.js') }}" type="text/javascript"></script>
    ...
    <script src="{{ asset('public/js/reporte/despacho.js?v='.$version) }}" type="text/javascript"></script> 
@stop