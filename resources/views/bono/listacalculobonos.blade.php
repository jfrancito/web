          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">Calcular Bono
                  <div class="tools tooltiptop">

                    <form method="POST" id='formpedido' class='opciones' action="{{ url('/cambiar-estado-bono/'.$idopcion) }}" style="display: inline-block;" >
                      {{ csrf_field() }}
                      <input type="hidden" id='pedido' name='pedido'>
                        <a href="#" class="tooltipcss enviarcalculobono" id='enviarcalculobono' data_estado='EPP0000000000004'>
                    ...
                    <a href="#" class="tooltipcss opciones buscarasientomodelo">
                      <span class="tooltiptext">Buscar Calculo Bonos</span>
                      <span class="icon mdi mdi-search"></span>
                    </a>

                    <a href="{{ url('/agregar-calculo-bono/'.$idopcion) }}" class="tooltipcss">
                ...
                <div class="panel-body">
                  ...
                  <div class='listajax'>
                    @include('bono.ajax.alistacalculobonos')
                  </div>
