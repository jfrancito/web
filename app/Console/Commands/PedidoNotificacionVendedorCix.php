...
class PedidoNotificacionVendedorCix extends Command
{
     ...
     * @var string
     */
    protected $signature = 'pedidonotificacion:vendedorcix';
    /**
    ...
    public function handle()
    {
        ...
        $lista_pedidos                  =   WEBPedido::where('WEB.pedidos.ind_notificacion','=',0)
                                            ...
                                            //->where('WEB.pedidos.centro_id','=','CEN0000000000001')
        ...
        foreach($lista_pedidos as $item){
            ...
            $email              =   WEBMaestro::where('codigoatributo','=','0001')->where('codigoestado','=','00011')->first();
