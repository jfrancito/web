...
class DesactivarPedidos extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'desactivar:desactivarpedidos';
    /**
    ...
    public function handle()
    {
        ...
        /********************************* DESACTIVAR REGLAS ****************************/
        $stmt = DB::connection('sqlsrv')->getPdo()->prepare('SET NOCOUNT ON;EXEC web.culminar_pedidos');
        $stmt->execute();
        ...
        if( (int)$resultado['cantidad'] > 0){
            ...
            $email     = WEBMaestro::where('codigoatributo','=','0001')->where('codigoestado','=','00023')->first();
